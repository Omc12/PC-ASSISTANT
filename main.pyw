...
while True:
    ...
    button1 = tk.Button(frame, text="QUIT", fg="white", command=quit, bd=0, bg='black', padx='50px')
    button1.bind("button1")
    button1.pack(side=tk.LEFT)
    button2 = tk.Button(frame, text="START", fg="white", command=assistant, bd=0, bg='black', padx='50px')
    button1.bind("button2", assistant)
